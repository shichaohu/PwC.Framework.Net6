    ...
    public class BaseService : IBaseService
    {
        ...
        protected ServiceClient ServiceClient
        {
            get
            {
                ...
                return new ServiceClient(crmConnectionString);
            }
        }
        public BaseService(ICommonInjectionObject commonInjectionObject)
        {
            ...
            if (commonInjectionObject?.HttpContextAccessor?.HttpContext?.Request != null)
            {
                ...
                {
                    crmConnectionString = _crmClientFactory.GetConnectString(crmClientTypeEnum);
                    _cRequest = _crmClientFactory.GetCRMClient(crmClientTypeEnum);
                }
            }

            crmConnectionString ??= _crmClientFactory.GetConnectString(CRMClientTypeEnum.Default);
            _cRequest ??= _crmClientFactory.GetCRMClient(CRMClientTypeEnum.Default);
